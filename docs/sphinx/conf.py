# -*- coding: utf-8 -*-
#
# stressor documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'stressor.tex', u'stressor Documentation',
...
man_pages = [
    (master_doc, 'stressor', u'stressor Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'stressor', u'stressor Documentation',
   author, 'stressor', 'One line description of project.',
   'Miscellaneous'),
]
